...
public class BasicCopybookConvert {
  public static void main(String[] args) throws Exception {
    ...
    if (args.length == 0) {
      System.out
          .println("BasicCopybookConvert <cbl file> <data file> <output file>");
      System.out.println("");
    ...
    ExternalRecord externalRecord = copybookInt
        .loadCopyBook(cbl, CopybookLoader.SPLIT_NONE, 0, "cp037",
